...
export const products: Product[] = [
  ...
  },
  {
    ...
    thumbnail: '/goods/phone-cases/phone_case_yongrin_main.jpg',
        description: '손 안에서 느껴지는 용의 웅장함! 청멍이의 신비로운 비늘을 형상화한 폰케이스로 여러분의 스마트폰을 특별하게 만들어 보세요. 견고한 보호력은 물론, 시선을 사로잡는 아름다움을 선사합니다. 빛의 각도에 따라 오묘하게 빛나는 이리데슨트(Iridescent) 효과와 특수 TPU & PC (홀로그램 코팅) 소재로 제작되었습니다.',
  ...
  },
  {
    ...
    thumbnail: '/goods/pendants/pendant_yeoiju_main.jpg',
        description: '청멍이의 가장 소중한 보물, 여의주를 당신의 품에! 한정 수량으로 제작되는 특별한 펜던트로, 지니는 이에게 행운과 소원 성취의 기운을 전해줄 것입니다. 소장 가치 200%! 영롱한 푸른빛의 스와로브스키 크리스탈 구슬이 섬세한 용 비늘 패턴의 925 실버 세공에 감싸여 있습니다.',
  ...
  },
  {
    ...
    thumbnail: '/goods/badges/badge_set_yongan_main.jpg',
        description: '청멍이의 지혜와 통찰력을 담은 용안 뱃지 세트! 가방이나 옷에 달아 청멍이의 신비로운 기운을 함께하세요. 깊은 푸른색과 금색 테두리가 어우러져 몽환적인 분위기를 연출합니다. 총 3가지 디자인 (정면, 측면, 감은 눈)으로 구성되어 있으며, 금속 에나멜 코팅으로 제작되었습니다.',
