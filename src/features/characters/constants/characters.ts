...
export const characters: Character[] = [
  {
    ...
    originStory:
      '구릉포에는 아홉 마리의 용이 승천했다는 전설이 있습니다. 하지만 마지막 한 마리의 용은 승천하지 못하고 남게 되었고, 그 용의 후예라고 믿고 싶은 청명이는 청룡이 되고 싶어합니다. 과거 용의 영광과 미래 혁신 잠재력을 연결하는 존재입니다.',
  ...
  },
  {
    ...
    persona: '현실과 이상의 균형자',
    personaIntro:
      '청명이의 꿈을 현실로 연결하는 조력자. 실용적인 조언과 효율적인 시스템을 통해 지역의 경제적 성장을 돕습니다.',
    originStory:
